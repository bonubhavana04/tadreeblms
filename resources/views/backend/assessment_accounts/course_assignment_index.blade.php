        ...
        <div class="row">
            <div class="col-12">
                            ...
                            <div class="custom-select-wrapper mt-2">
                                <select class="form-control custom-select-box select2 js-example-placeholder-single" name="user" id="user">
                                    ...
                                    @foreach($internal_users as $user)
                                        <option value="{{ $user->id }}" @if($user->id == request()->user) selected @endif>
                                            {{ $user->email }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="custom-select-wrapper mt-2">
                                <select name="course_id" id="course_id" class="select2 form-control custom-select-box">
                                    ...
                                    @foreach($published_courses as $row)
                                        <option value="{{ $row->id }}" @if(isset($selectedCourse) && $row->id == $selectedCourse) selected @endif>
                                            {{ $row->title }}
                                        </option>
                                    @endforeach
                                </select>
                ...
                <div class="table-responsive">
                    <table id="myTable" class="table dt-select custom-teacher-table table-striped @if(auth()->user()->isAdmin()) @if(request('show_deleted') != 1) dt-select @endif @endcan" style="width: 1300px;">
                        <thead>
                            <tr>
